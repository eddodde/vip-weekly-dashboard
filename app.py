...
# 화면에는 실행명 + 한 줄만. 대상·소재·채널은 임원 보고에 불필요한 실무 상세라
# title 속성(마우스 오버)으로만 남겨, 질문이 나오면 그 자리에서 열어볼 수 있게 한다.
LEVERS = [
    ("유입율", [
        ("슈즈 이탈 고객 윈백", "10만원대 대체 브랜드 소구",
         "대상 25년 슈즈 10만원대 구매·26년 미구매 / 소재 우포스·킨·리복 / LMS·홀드아웃 5%"),
        ("미방문 VIP 재방문 유도", "행사·신규 입점 소구",
         "대상 최근 30일 미방문 VIP / 소재 진행 전관행사·신규 입점 / 앱푸시+LMS·홀드아웃 5%"),
    ]),
    ("전환 CR", [
        ("지원금 미사용 리마인드", "사용 조건 도달 안내",
         "대상 쇼핑지원금 보유·미사용 / 소재 20만원 이상 구매 시 사용 가능 / LMS·사용률 측정"),
        ("조회·미구매 리타겟", "조회 브랜드 한정 쿠폰",
         "대상 최근 7일 조회·미구매 / 소재 조회 브랜드 한정 쿠폰 발행 / 앱푸시·쿠폰 사용률"),
    ]),
    ("객단가", [
        ("구매 임계 상향 유도", "추가 구매 시 혜택 안내",
         "대상 지원금 사용조건(20만원) 직전 구간 / 소재 추가 구매 시 사용 가능 안내 / LMS·객단가"),
        ("상위등급 시크릿 제안", "단독 혜택 쿠폰",
         "대상 Gold 이상·고단가 브랜드 이력 / 소재 단독 혜택 쿠폰 발행 / LMS·등급 내 객단가"),
    ]),
]

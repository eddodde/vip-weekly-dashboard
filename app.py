...
LEVERS = [
    ("visit", "유입율", [
        ...
        # ★ '이탈/윈백'으로 부르지 말 것 — 대상은 떠난 고객이 아니라 플랫폼에 남아 있으면서
        #   슈즈만 안 사는 고객이다. 08월 4주차 슈즈 감소(△202.4명)가 전체 구매고객
        #   감소(△179.6명)보다 크다는 건 상당수가 타 카테고리에서는 샀다는 산술적 증거.
        ("슈즈 구매 중단 고객 재소구", "이탈이 아니라 슈즈 지갑이 닫힘", [
            "상품관점 기준 (대시보드와 동일 소스)",
            "09월 1주차 구매고객 210.6 → 70.9명 (△66.4%) — 전 카테고리 최대",
            "감소 카테고리 합계의 약 40%가 슈즈 한 곳 (2위 골프의 2배)",
            "8월 3주 △62.1% · 4주 △78.1% · 9월 1주 △66.4% · 2주 △50.9% — 4주 연속",
            "조회(상품UV)부터 3,407 → 1,659 (△51.3%) — 보러 오지도 않음",
            "전환(상품CR) 6.18% → 4.27% (△30.9%) — 본 사람도 덜 삼",
            "08월 4주차 슈즈 감소 △202.4명 > 전체 구매고객 감소 △179.6명",
            "→ 상당수는 타 카테고리로 이동, 완전 이탈은 일부",
            "→ 조회부터 죽어 있으므로 노출·인지가 먼저",
            "※ 카테고리별 집계라 복수 카테고리 구매 고객은 중복 계상",
            "※ 대체 브랜드 성장(우포스·킨)은 브랜드 파일(전사·8월) 기준"]),
        ("미방문 VIP 재방문 유도", "회원수는 유지, 방문율만 하락", [
            "유효회원수 △0.5% — 회원 이탈이 아님",
            "빠지는 것은 유입율 한 축",
            "8월 발송 재개(0→23건) 구간에서 PUSH DAU 낙폭 △14.3% → △5.8%"]),
    ]),
    ("cr", "전환 CR", [
        ("혜택 미사용 리마인드", "방문보다 전환이 더 크게 하락", [
            "엘페스타 기간 DAU는 전년 대비 증가",
            "그럼에도 구매고객 △14.4%, CR △11.3%",
            "유입이 아니라 전환이 병목",
            "전관행사는 방문 견인 효과가 제한적 → 전환 레버 우선"]),
        ("조회·미구매 리타겟", "방문은 유지, 구매 전환만 이탈", [
            "유입이 늘어난 채널에서도 전환은 하락",
            "광고 방문 +18.5% / 전환 △8.3%",

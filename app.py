...
if _brand_ok:                                   # ── 브랜드(8월 마감)
    _dg_lines += [
        "· <b>부진은 핏플랍 하나</b> — 전년 631,246,391원·5,264명 → 405,727원·5명(자사 거래액의 6.6% 차지했던 브랜드). "
        "<b>핏플랍 제외 시 자사 +10.1%·고객 +3.1%</b>(표면 +2.8%·△10.6%), 전체는 <b>+10.2%·고객 +0.6%</b>",
        "· <b>성장 브랜드 = 8월 발송·라이브 대상</b> — 아떼 바네사브루노 655→1,180명·바버 773→1,185명·"
        "닥스 여성 1,708→1,934명·알레그리 남성 54→340명. 슈즈 대체재 킨 412→721명",
    ]

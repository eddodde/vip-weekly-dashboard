...
DONE = [
    ("visit", "최근 조회 상품 리마인드 확대", "09월 2주차", [
        ("유입 증분", "+172명/일 — 개선분의 137%", True),
        ("발송 대비 유입", "3.82% → 6.26%", False),
        ("일평균 발송 대상", "2,128 → 4,043명 (+90%)", False),
        ("주간 거래액", "6,094,890 → 13,744,562원", False)], [
         ...
         "유입 일평균 81 → 253명, 증분 172명 = 전주 대비 DAU 개선분(125명)의 137%",
         "★ 137%를 '이 건이 개선을 만들었다'로 읽으면 안 된다. 같은 기간 문자 전체",
         "  유입은 5,155 → 5,006명으로 148명 줄었다(EV01 외 △320명).",
         "  이 건은 순증을 만든 것이 아니라 타 문자 감소분의 54%를 상쇄한 구조이며,",
         "  '없었으면 DAU가 더 빠졌다'가 정확한 진술이다",
...
SMS_TOTAL = ("visit", "DAU 개선 분해", "09월 2주차 vs 1주차", [
    ...
    ("CRM 문자 유입", "5,155 → 5,006명/일 (△148)", False)], [
    ...
    "CRM 문자 유입(일평균): 전체 5,155 → 5,006명(△148),",
    "  EV01 81 → 253명(+172), 그 외 5,073 → 4,753명(△320)",

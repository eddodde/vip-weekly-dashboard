...
BRAND_ASOF = datetime.date(2026, 8, 25)
_brand_gap = abs((_dg - BRAND_ASOF).days) if _dg else 99
_brand_ok = _brand_gap <= 7

_dg_lines = []
if _brand_ok:                                   # ── 브랜드·상품퍼널 분석(정적, ~8/23)
    _dg_lines += [
        "· <b>유입은 회복, 전환이 무너짐</b> — 8월 주차별 DAU △9.2%→△8.7%→<b>△7.7%</b>(연중 최저 낙폭)인 반면 "
        "CR은 △0.4%→△6.0%→<b>△8.2%</b>로 역주행. 페스타 주간(8/17~23) 거래액 △8.8%의 직접 원인",
        "· <b>퍼널 분해: 방문 회복분이 상품까지 도달하지 않음</b> — 상품UV는 △7.5%→△6.8%→△6.9%로 정체(DAU만 개선), "
        "상품CR은 12.49%→<b>11.38%</b>. 유입 확대가 상품 조회·구매로 이어지지 않는 구조",
        "· <b>부진 원인이 카테고리별로 다름(자사 3주차)</b> — 슈즈는 상품UV △69.2%로 <b>볼 상품 자체가 부재</b>(CR은 △5.8%로 양호), "
        "반면 남성(CR △15.7%)·잡화(△12.2%)는 <b>UV는 유지되나 결제 전환이 이탈</b>. 전자는 입점, 후자는 구성·가격 이슈",
        "· <b>자사 8월 누계(~8/23) +3.6%</b> — 패션 +11.6%·잡화 +33.8%가 견인, 슈즈 △61.3%(△271,346,464원)가 상쇄. "
        "슈즈 감소는 핏플랍(△319,293,500원)·바쉬(△79,892,728원)·콜한(△30,492,682원) 3개 브랜드에 집중",
        "· <b>성장 브랜드는 라이브·타겟 대상과 일치</b> — 아떼 바네사브루노 +110.5%, 이자벨마랑 +86.1%, "
        "닥스 액세서리 +56.9%, 바버 +43.1%, 닥스 여성 +24.4%. <b>8/20 여성컨템 본방송일 △1.4%</b>로 페스타 주중 최고 "
        "(전후 △20.0%·△6.0%) — 성장 브랜드 × 본방송 조합 재검증",
        "· <b>슈즈 대체재 작동 중이나 규모 부족</b> — 킨 +50.1%(+28,050,090원)·우포스 VIP 1→104명으로 회복 흐름이나 "
        "핏플랍 공백의 9% 수준. 5~10만원대 대체 입점 없이는 슈즈 회복 불가",
        "· <b>등급 구조(~8/12 기준)</b> — 전년 핏플랍 구매층의 <b>86.9%가 하위2등급</b>(15,212명 중 13,214명). "
        "커버낫 포함 두 브랜드 철수가 하위2등급 고객 감소분 24,976명의 <b>61.1%</b>를 설명. "
        "하위2등급 구매고객 76,350→51,374명은 곧 VIP 승급 모수 축소로 연결",
    ]
_dg_lines += [                                  # ── 구조 결론(기간 무관) + 자동 갱신 지표
    ...
    "월내 흐름도 3주 저점(16,439) → 5주 17,091로 반등(발송 집중 시점과 일치)",
    "· <b>여름은 저단가 상품이 전환(CR)을 견인하는 시즌</b>(객단가↔CR 역상관 △0.76)이라 "
    "저단가 구색 공백이 6월부터 CR 역신장으로 전이. 행사·앱 사용성이 주요인일 가능성은 낮음 — "
    "행사일/비행사일 하락폭 동일, 여성·뷰티·리빙 상품CR은 +4~5% 상승(저가 카테만 하락)",
    "· <b>상반기 CR 우위(+5~10%)는 전년 PUSH·광고 전환 개선의 기저효과</b>로 6월 소진. "

    ...
    ("visit", "유입율", [
        ...
        ("고관여 브랜드 라이브 모수 확대", "브랜드별 유입률이 5배까지 벌어짐",
         _imp(("역신장 축소", "0.51%p", True),
            ...
            "  9/15 화 바버아울렛       28,452,227원  +63.7%  ← 3순위",
            "  9/16 수 히스헤지스       10,283,982원  전년 0(신규 라인)",
        ...
        ("닥스 여성·뷰티 기획전 발송", "금주 편성 — 브랜드 실적이 뒷받침",
         _imp(("역신장 축소", "1.62%p", True),
            ...
            "── 금주 기획전 브랜드 실적 (VIP·09월 2주차) ──",
            "  닥스 여성   71,090,590 → 118,105,818원  +66.1%",
            "    e-영업2 패션 50,131,591 → 89,946,000원(+79.4%)이 견인",
            "    e-영업1 패션 15,125,000 → 20,718,636원(+37.0%)",
            "  아떼뷰티     5,705,545 →   9,562,309원  +67.6%",
            "★ 닥스 여성은 금주 라이브 편성 최대 건(닥스ACC 75,796,045원)보다도 크다",
            "── 준거 ──",
            "동일 유형 실측: 자사 1BPU 상품 LMS(스웨이드&퍼)",
            "  발송 25,611명 → 유입 8.34%(2,135명) · 1명당 655원",
            "  1회 발송분을 주간 일평균으로 환산 · %p는 전년 18,861명 기준",
            "  닥스 여성은 준거 브랜드보다 규모가 크므로 보수적인 값이다",
            "★ 리드타임 없음 — 기획전은 이미 편성돼 있고 발송 1건을 붙이는 것이라",
            "  소재 제작·대상 추출을 새로 하지 않는다",
            "대상: 닥스 여성·아떼뷰티 구매·조회 이력 보유 VIP / 채널: LMS",
            "측정: 발송 대비 유입률(준거 8.34%), 1명당 거래액(준거 655원)",
            "※ 뷰티는 브랜드를 좁혀 쓸 것 — e-영업4 뷰티 카테고리 상품UV는 △30.5%로",
            "  전반이 빠지는 중이고, 헤라 △52.5%·오휘 △43.3%다. 아떼뷰티만 +67.6%",
            "※ 닥스 골프 여성(33,364,136원, △13.0%)은 별개 라인이므로 섞지 말 것"]),
...
# ★ 목표를 두괄식으로 맨 위에 둔다. 회의에서 먼저 읽히는 자리다.
# ★ 레버 효과를 '순증'으로 잡지 말 것. 지난주 DAU 18,105명에는 이미 라이브 7건과
#   캠페인 전량(발송 730,063명)이 들어 있고 금주에도 비슷한 양이 나간다. 따라서

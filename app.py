...
st.markdown(
    ...
    "🔍 <b>참고 · 구조 진단 (7월 심층분석 요약)</b> <span style='color:#a08b5f'>— 분석 기준 ~7/19 집계"
    "(브랜드 단위 수치만 ~7/13 브랜드별 집계)</span>"
    "<br>· <b>고객수 감소(△12.3%)는 저단가 구매 위축이 주도</b> — 객단가 하위 브랜드 구매고객 △30~46%, 20~40만 프리미엄대만 +10%. "
    "객단가 상승(+11.8%)은 그 반사효과(총거래액 미성장·퍼널 위축 → 프리미엄화 아님)"

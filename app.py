...
st.markdown(
    ...
    "브랜드 수치는 ~7/26 브랜드 집계, 코호트는 7월 심층분석 기준</span>"
    f"<br>· <b>고객수 감소({_pct(_dg_c)})는 저단가 구매 위축이 주도</b> — 5만 미만 브랜드 구매고객 △32%, 5~20만 △12~18%, "
    f"20~40만 프리미엄대만 +3%(20만↑ 전체는 신규 유입 포함 +12%). 객단가 상승({_pct(_dg_a)})은 그 반사효과"
    "(총거래액 미성장·퍼널 위축 → 프리미엄화 아님)"
    "<br>· <b>객단가 상승 분해(주문건수 기준): 인당 구매횟수 불변, 건당 금액만 +11.1%</b> — "
    "그중 브랜드 내 단가 인상분은 중앙값 +4.5%(41%는 하락)로 일부일 뿐, 대부분은 고가 브랜드·아이템으로의 구매 쏠림"
    "<br>· <b>슈즈 급감(△42%)은 '25.9월 핏플랍 철수 공백</b>이 샌들 성수기에 표면화된 것"
    "(전년 슈즈 거래액의 53%, 핏플랍 제외 시 슈즈 +23% 성장) — 7~8월 지속, 9월부터 기저 소멸. "
    "저가 브랜드 축소도 저가존 집중(10만 미만 △12%·−185개)"
    "<br>· <b>라이브 실측(7/20~26): 바버(7/21 라이브) 주간 거래액 전년비 +146%(+0.31억)</b> vs 전사 △11% — "

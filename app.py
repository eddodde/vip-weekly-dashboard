    ...
    ("visit", "유입율", [
        ...
        ("고관여 브랜드 라이브 모수 확대", "브랜드별 유입률이 5배까지 벌어짐",
         _imp("모수 1만명 추가당 역신장 축소 0.51%p · DAU +96명/일 · 거래액 +2,753,790원",
            ...
            "── 금주 라이브 편성 판정 ──",
            "  9/14 월 재방송 아떼ACC        고관여 — 9/11 발송 42,570명 6.52%",
            "  9/15 화 VOD  바버아울렛(재)    중간 — 실측 없음, e-영업2 남성 +7.6%",
            "  9/16 수 본방송 히스헤지스 경량패딩 고관여 — 헤지스ACC 6.90%, 남성 +8.5%",
            "  9/17 목 본방송 스타우브&장듀보   저관여 — 리빙 상품UV △0.1%, 비패션",
            "  9/18 금 재방송 놋담            저관여 — 리빙, 실측 없음",
            "  9/20 일 본방송 닥스ACC         중간 — 9/11 닥스아모레 9,940명 3.52%",
            "→ 9/14 아떼ACC·9/16 히스헤지스에 모수를 더 태운다",

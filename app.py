...
LEVERS = [
    ("유입율", [
        ("슈즈 이탈 고객 윈백", "구매고객 감소의 84%가 슈즈", [
            ...
            "전체 감소 4,886명 중 4,081명이 슈즈",
            "10만원대 구매층 5,939 → 1,331명, 4,608명 미충족",
            "대체 브랜드는 지원 없이도 성장 (우포스 0→242, 킨 51→203)"]),
    ...
    ("객단가", [
        ...
        ("구매 임계 상향 유도", "거래액을 지탱하는 축이 객단가 하나", [
            "구매고객은 감소하는데 객단가만 상승해 거래액을 방어 중",
            "객단가 쿠션이 얇아지면 곧바로 역신장 전환",
            "쇼핑지원금 사용 조건이 20만원 → 직전 구간에 추가 구매 유인이 구조적으로 존재",

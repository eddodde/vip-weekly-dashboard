...
LEVERS = [
    ("visit", "유입율", [
        ...
        ("9/10 쇼핑찬스 발송 실패 회수", "같은 캠페인이 전날 대비 유입 1/8",
         _imp("역신장 1.34%p 축소 (DAU +252명/일) · 거래액 +6,520,906원/주",
              "전날 동일 캠페인(9/9 쇼핑찬스, 발송 30,295명 → 유입 4.23%·1명당 167.7원)을 "
              "벤치마크로 최대 1건(48,077명)에만 적용한 보수치 · "
              "%p는 전년 09월 2주차 DAU 18,861명 기준"), [
            "9/9  쇼핑찬스 발송 30,295명 → 유입 1,280건(4.23%) · 1명당 167.7원",
            "9/10 쇼핑찬스 발송 48,077명 → 유입   267건(0.56%) · 1명당  32.1원",
            ...
            "※ 이 건은 개선 시책이 아니라 장애 회수다. 재발 방지(발송 후 D+1 유입률",
            "  임계 점검)를 함께 걸어야 반복되지 않는다"]),

...
st.markdown(
    ...
    "🔍 <b>참고 · 구조 진단 (7월 심층분석 요약)</b> <span style='color:#a08b5f'>— 분석 기준 ~7/19 집계</span>"
    "<br>· <b>고객수 감소(△12.3%)는 저단가 구매 위축이 주도</b> — 5만 미만 브랜드 구매고객 △32%, 5~20만 △11~15%, "
    "20~40만 프리미엄대만 +4%. 객단가 상승(+11.8%)은 그 반사효과(총거래액 미성장·퍼널 위축 → 프리미엄화 아님)"
    ...
    "(전년 슈즈 거래액의 53%·고객 2,766명, 핏플랍 제외 시 슈즈 +27% 성장) — 7~8월 지속, 9월부터 기저 소멸. "
    ...
    "<br>· <b>방문 기반: 회원 수 유지(△0.7%), 방문율만 하락(34.3→31.3%)</b> — 감소분은 직접·PUSH 채널(습관성 방문, 도달 △14~15%). "
    "PUSH 전환은 주별 등락(△9~+6%)이나 도달 회복이 우선 과제"
    "<br>· <b>현 구조는 플러스 전환 문턱이 낮음</b> — 객단가 쿠션(+11.8%)이 DAU 감소를 상쇄하고 +2.3%p 여유. "
    "CR 전년 수준 회복 시 거래액 전년비 +1.2% 전환 가능(20만↑ 조건부 전환 경로 기준, 쿠션 유지되는 7~8월 한시)"

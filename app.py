...
LEVERS = [
    ("visit", "유입율", [
        ...
        ("발송 요일 편중 해소", "역신장 큰 요일에 발송이 얇음",
         _imp("역신장 축소 1.70%p · DAU +321명/일 · 거래액 +11,932,858원/주",
              "화·일 발송을 중위일(금 82,433명) 수준으로 올린 46,749명에 주간 전체 "
              "유입률 4.80%·1명당 255원 적용 · 해당 요일 실측(6.39~6.40%)이 아닌 "
              "보수치 · %p는 전년 09월 2주차 DAU 18,861명 기준"), [
            "09월 2주차 일자별 — 전년비가 나쁜 날이 발송이 얇은 날과 겹친다",
            "  월 9/7  △2.42%  발송 169,670  유입 9,338",
            "  화 9/8  △7.70%  발송  65,045  유입 4,159  ← 발송 하위 2위",
            "  수 9/9  △2.18%  발송 120,545  유입 5,141",
            "  목 9/10 △5.74%  발송 167,308  유입 1,854  ← 쇼핑찬스 장애로 유입만 붕괴",
            "  금 9/11 △1.76%  발송  82,433  유입 6,098",
            "  토 9/12 △2.58%  발송  71,990  유입 5,057",
            "  일 9/13 △5.47%  발송  53,072  유입 3,397  ← 발송 최저",
            "★ 유입 건수와 일별 전년비의 상관 r=0.635. 발송 대상 수와는 r=0.223에",
            "  그치는데, 목요일이 발송은 많고 유입은 없었던 장애일이기 때문이다.",
            "  즉 물량이 아니라 '실제 들어온 수'가 그날 DAU를 설명한다",
            "★ 리드타임 없음 — 발송 스케줄 배분만 조정하면 되고 소재·대상은 그대로",
            "대상: 화·일 발송 물량을 중위일 수준으로 / 채널: LMS·SMS",
            "측정: 요일별 유입 건수 편차, 화·일 전년비",
            "※ 화·일 유입률이 높은 것(6.39~6.40%)은 물량이 적어 고관여 대상만 남은",
            "  결과일 수 있다. 물량을 늘리면 유입률은 떨어지므로 주간 평균을 적용했다",
            "※ 표본 7일의 상관이라 단정하지 말 것 — 2주 더 확인 후 상시화 판단"]),
